...
import kr.co.seonhyeokjun.eatgo.interfaces.ReviewController;
...
public class ReviewControllerTests {
    ...
    @Test
    public void createWithVaildAttriutes() throws Exception {
    ...
    @Test
    public void createInvalidAttriutes() throws Exception {
        mvc.perform(post("/restaurants/1/reviews")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{}"))
